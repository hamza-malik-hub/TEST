...
class Truck(Vehicle):
    ...
    def load_cargo(self, weight):
        if weight <= self.load_capacity:
            ...
            print(f"Error: Cannot load {weight} tons. Max capacity is {self.load_capacity} tons.")

truck1 = Truck("Volvo", "FH16", 2023, 25)
truck1.display_info()
truck1.load_cargo(20)
truck1.load_cargo(30)
...
cart = ShoppingCart()
cart.add_item("mango", 6)
cart.add_item("orange", 7)
cart.view_cart()
cart.remove_item("mango", 6)
cart.view_cart()
cart.remove_item("oange", 7)
cart.view_cart()
cart.clear_cart()
cart.view_cart()
